	...
	<form action="update.do" method="post">
		...
		<table>
			...
			<tr>
				<th>입사일</th>
				<td>
					<input type="date" name="tempHiredate" value="${empDto.hiredate.toString().substring(0,10) }">	
				</td>
			</tr>
			<tr>
				<th>급여</th>
				<td>
					<input type="number" name="sal" value="${empDto.sal }">
				</td>
			</tr>
			<tr>
				<th>상여</th>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="목록" class="btn" onclick="location='${conPath }/empDeptList.do?pageNum=${param.pageNum }'">
				</td>
			</tr>
		</table>
	</form>
