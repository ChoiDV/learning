...
public class EmpServiceImpl implements EmpService {
	...
	public List<Emp> empDeptList(String pageNum) {
		Paging pagin = new Paging(empDao.totCnt(),pageNum, 10, 5);
		Emp emp = new Emp();
		emp.setStartRow(pagin.getStartRow());
		emp.setEndRow(pagin.getEndRow());
...
//			emp.setHiredate(Date.valueOf("2022-07-21"));  // Date형으로 했을경우 여기에는 시간을 넣을 수 없음
			emp.setSal(i);
			emp.setComm(i/10);
			emp.setDeptno(40);
