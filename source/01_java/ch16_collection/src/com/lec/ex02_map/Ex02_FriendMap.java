...
public class Ex02_FriendMap {
	public static void main(String[] args) {
		...
		friends.put("010-8888-8888", new Friend("마길동","010-8888-8888",new Date(95,11,12)));
		friends.put("010-7777-7777", new Friend("유길동","010-7777-7777"));
		friends.put("010-6666-6666", new Friend("신길동","010-6666-6666"));
		friends.put("010-5555-5555", new Friend("이길동","010-5555-5555"));
