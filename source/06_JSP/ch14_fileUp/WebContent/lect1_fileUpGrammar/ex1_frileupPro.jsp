...
<body>
	<%
		...
		/*************************************************************************************/
		// 안녕 진영아 예쁜누나 또 왔다 ㅎㅎㅎㅎㅎ 너가 이 주석을 찾아 낼 수 있을지 모르겠지만 발견하면 선물 있어! >0< 바로 치코리타 방구공격이얌 
		}catch(IOException e){
		...
		try{
			...
			if(serverfile.exists()){ //첨부한 파일이 있는지 
				...
				os = new FileOutputStream("D:/Java_Choijinyoung/source/06_JSP/ch14_fileUp/WebContent/fileUpFolder/" 
																	+filename);//복사될 파일
