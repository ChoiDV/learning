...
<head>
 ...
 <body>
<%-- 	이쁘게 ${requestScope.content_view } ${param.bid } ${param.pageNum } 출력한다 --%>
	<table>
		...
		<tr>
			<td colspan="2">
				...
				<button onclick="location.href='${conPath}/delete_view.do?bid=${content_view.bid }&pageNum=${param.pageNum }'">삭제</button>
