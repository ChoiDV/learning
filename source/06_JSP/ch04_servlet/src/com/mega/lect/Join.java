...
public class Join extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// pwChk 는 어차피 html에서 pw와 같은것을 확인하기때문에 따로 안받음
		...
		// 이렇게 하면 birth2 는 date형 birth
		String[] hobby = request.getParameterValues("hobby");  // 배열 || null 
		String gender = request.getParameter("gender");
		String email = request.getParameter("email");
		String[] mailSend = request.getParameterValues("mailSend"); // 배열 null이 들어올수 없음 
		...
		out.println("<h2>생년월일(java.sql.Date 형) : " + birth2 + "</h2>");
