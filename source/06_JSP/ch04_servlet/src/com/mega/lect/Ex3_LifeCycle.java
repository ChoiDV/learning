...
public class Ex3_LifeCycle extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		// 객체 생성될 때, 최초 한 번 수행
		System.out.println("Ex3_LifeCycle 서블릿 객체가 생성되었을 때 수행");
	}
	@PostConstruct
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {			
		// 클라이언트의 요청이 들어왔을때 수행 ( service메소드가 있으면 doGet/doPost() 실행 안됨.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 클라이언트 요청이 get방식으로 들어왔을 때 수행(service함수가 없을 때) service 함수가 있으면 실행안함
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 클라이언트 요청이 post방식으로 들어왔을 때 수행(service함수가 없을 때) service 함수가 있으면 실행안함
	...
	public void destroy() {
		...
		System.out.println("destory() 실행(메모리 해제)");
	}
