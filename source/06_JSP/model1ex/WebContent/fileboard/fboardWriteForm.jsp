...
<head>
 ...
 <body>
    ...
    <%
    	...
    	FileBoardDto dto = new FileBoardDto(); // 빈 dto 객체에( fnum, fref, fre_step, fre_level은 0)
    	if(request.getParameter("fnum") != null){  // 답글 쓰러왔음
    ...
    <form action="fboardWritePro.jsp" method="post" enctype="multipart/form-data">
    	...
    	<table>
    		...
    		<tr>
    			<td colspan="2">
    				<input type="submit" value='<%=fnum == 0 ? "원글 쓰기 " : "답글 쓰기" %>' class="btn">
