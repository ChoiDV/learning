 ...
 <body>
 	<form action="joinOk.jsp" method="post" name="join_frm">
 		<table>
 			...
 			<tr>
 				<th>비밀번호</th><th><input type="password" name="pw"></th>
 			</tr>
 			<tr>
 				<th>비번확인</th><th><input type="password" name="pwChk"></th>
 			</tr>
 			<tr>
 			...
 			<tr>
 				<th>생년월일</th>
 				<td>
 					<input type="date" name="tempbirth">  <!-- name=birth로 하면 나중에 bean태그가 안먹음 왜? 모름 -->
 				</td>
 			</tr>
 			<tr>
 				<th>주소</th>
