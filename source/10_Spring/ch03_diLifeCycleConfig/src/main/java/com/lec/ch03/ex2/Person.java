...
@Data
@AllArgsConstructor  // 모든 필드가 들어있는 생성자 함수만 생성 
public class Person implements InitializingBean, DisposableBean, EnvironmentAware {
	...
	public void afterPropertiesSet() throws Exception {
		System.out.println("Person형 Bean 객체 생성하자마자 실행2 : afterPropertiesSet() 호출");
	}
	@Override
	public void destroy() throws Exception {
		System.out.println("Person형 Bean 객체 소멸 바로 전 실행 : destroy() 호출");
	}
